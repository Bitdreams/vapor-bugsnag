...
Org-wide context lives in the Bitdreams knowledge base at `../[private]/` — see [AGENTS.md](AGENTS.md). The primary consumer is the sibling `../[private]/`.
...
- Targets Linux (containerized Linux); also builds on macOS for development
